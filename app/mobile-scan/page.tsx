    ...
    return (
        <Box sx={{ px: 1.5, pb: 0.8, pt: 0.2 }}>
            ...
            <Stack direction="row" flexWrap="wrap" gap={0.5} sx={{ mt: 0.3 }}>
                ...
                {info.mrp && (
                    <Chip label={`MRP ₹${info.mrp}`} size="small" sx={{ height: 22, fontSize: '0.7rem', fontWeight: 600, bgcolor: isDark ? '#14532d' : '#dcfce7', color: isDark ? '#86efac' : '#166534' }} />
                )}
                {info.fsp && (
                    <Chip label={`FSP ₹${info.fsp}`} size="small" sx={{ height: 22, fontSize: '0.7rem', fontWeight: 600, bgcolor: isDark ? '#3b1764' : '#f3e8ff', color: isDark ? '#c084fc' : '#7c3aed' }} />
                )}
                {info.fsn && (
                ...
                {info.rack_no && (
                    <Chip label={`📍 ${info.rack_no}`} size="small" sx={{ height: 22, fontSize: '0.7rem', fontWeight: 600, bgcolor: isDark ? '#1c1917' : '#f5f5f4', color: isDark ? '#a8a29e' : '#57534e' }} />
                )}
                {info.cms_vertical && (
