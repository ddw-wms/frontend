...
export default function QCPage() {
  ...
  const [visibleColumns, setVisibleColumns] = useState(['wsn', 'rack_no', 'qc_grade', 'qc_remarks']);
                        ...
                        <Dialog open={columnSettingsOpen} onClose={() => setColumnSettingsOpen(false)} maxWidth="xs" fullWidth>
                          ...
                          <DialogContent>
                            <Box sx={{ pt: 2, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
                              {['wsn','rack_no', 'qc_grade', 'qc_remarks', 'product_serial_number'].map(col => (
