...
export default function CustomersPage() {
  ...
  return (
    <AppLayout>
      ...
      <Box sx={{ height: 'calc(100vh - 80px)', display: 'flex', flexDirection: 'column', background: 'linear-gradient(135deg, rgba(102, 126, 234, 0.03) 0%, rgba(118, 75, 162, 0.03) 100%)', p: 1.5 }}>
        {/* GRADIENT HEADER */}
        <Box sx={{ mb: 1.5 }}>
          <Box sx={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', p: 1.5, borderRadius: 2, boxShadow: '0 4px 20px rgba(102, 126, 234, 0.25)' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <Typography variant="h6" sx={{ fontWeight: 700, color: 'white', mb: 0.2, fontSize: '0.85rem' }}>👥 Customer Management</Typography>
          ...
          <CardContent sx={{ p: 1 }}>
            <Stack spacing={1}>
              ...
              <Stack direction={{ xs: 'column', md: 'row' }} spacing={1} alignItems="center">
                ...
                {/* ACTION BUTTONS */}
                <Stack direction="row" spacing={1} sx={{ display: 'grid', gridTemplateColumns: { xs: 'repeat(2, 1fr)', md: 'repeat(3, auto)' }, gap: 1, width: { xs: '100%', md: 'auto' } }}>
                  <Button
                    size="small"
                    startIcon={<AddIcon sx={{ fontSize: 14 }} />}
                    variant="contained"
                    onClick={() => handleOpenDialog()}
                    sx={{ height: 40, width: 100, fontSize: '0.75rem', fontWeight: 600, background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' }}
                  >
                    ADD
                  </Button>
                  <Button
                    ...
                    sx={{ height: 40, width: 100, fontSize: '0.75rem', fontWeight: 600, background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)' }}
                  >
                    EXPORT
                  </Button>
                  <Button
                    ...
                    sx={{ height: 40, width: 100, fontSize: '0.75rem', fontWeight: 600 }}
                  >
                    REFRESH
                  </Button>
                </Stack>
