...
export default function PickingPage() {
  ...
  const flushSyncRows = useCallback(() => {
    ...
    console.log('[SYNC] 📤 Sending', rows.length, 'row(s) to picking sync-rows API, warehouseId:', activeWarehouse.id);
    pickingAPI.syncRows(rows, activeWarehouse.id)
      .then(() => console.log('[SYNC] ✅ picking sync-rows API call succeeded'))
