      ...
      >
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", gap: 2, flex: 1 }}>
            {/* Available Stock */}
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, borderLeft: "3px solid #2196f3", pl: 1.5 }}>
              <Typography sx={{ fontSize: "0.7rem", color: "#666", fontWeight: 500, minWidth: "65px" }}>
                Available:
              </Typography>
              <Typography sx={{ fontSize: "1.1rem", fontWeight: 700, color: "#1976d2" }}>
                {inventorySummary.available_stock}
              </Typography>
            </Box>

            {/* Pending QC */}
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, borderLeft: "3px solid #ff9800", pl: 1.5 }}>
              <Typography sx={{ fontSize: "0.7rem", color: "#666", fontWeight: 500, minWidth: "65px" }}>
                Pending QC:
              </Typography>
              <Typography sx={{ fontSize: "1.1rem", fontWeight: 700, color: "#f57c00" }}>
                {inventorySummary.qc_pending}
              </Typography>
            </Box>

            {/* Ready for Dispatch */}
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, borderLeft: "3px solid #9c27b0", pl: 1.5 }}>
              <Typography sx={{ fontSize: "0.7rem", color: "#666", fontWeight: 500, minWidth: "65px" }}>
                Ready:
              </Typography>
              <Typography sx={{ fontSize: "1.1rem", fontWeight: 700, color: "#7b1fa2" }}>
                {inventorySummary.ready_for_dispatch}
              </Typography>
            </Box>

            {/* Dispatched */}
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, borderLeft: "3px solid #4caf50", pl: 1.5 }}>
              <Typography sx={{ fontSize: "0.7rem", color: "#666", fontWeight: 500, minWidth: "65px" }}>
                Dispatched:
              </Typography>
              <Typography sx={{ fontSize: "1.1rem", fontWeight: 700, color: "#388e3c" }}>
                {inventorySummary.dispatched_items}
              </Typography>
            </Box>
          </Box>
            ...
            control={
              <Checkbox
                ...
                onChange={(e) => {
                  ...
                  if (e.target.checked) {
                    toast.success("Showing available inventory only (Inbound - Outbound)");
                  } else {
