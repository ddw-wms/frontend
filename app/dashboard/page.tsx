...
//       FSP: item.fsp,
//       MRP: item.mrp,
//       'Inbound Date': item.inbound_date,
//       'Inbound Status': item.inbound_status,
//       'QC Date': item.qc_date,
//       'QC Status': item.qc_status,
//       'QC Grade': item.qc_grade,
//       'Picking Date': item.picking_date,
//       'Picking Status': item.picking_status,
//       'Outbound Date': item.outbound_date,
//       'Outbound Status': item.outbound_status,
...
//                 {activeWarehouse?.name} • {user?.full_name || user?.username}
//               </Typography>
//             </Box>
//           </Stack>
//         </Paper>
...
// mb: 2
// }}>
// <Card sx={{ p: 1.5, textAlign: 'center', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', color: 'white' }}>
// <Typography variant="h6" sx={{ fontSize: '1.3rem' }}>{metrics.total}</Typography>
// <Typography variant="caption">Total Items</Typography>
// </Card>
// <Card sx={{ p: 1.5, textAlign: 'center', background: 'linear-gradient(135deg, #f093fb 0%, #f5576c 100%)', color: 'white' }}>
// <Typography variant="h6" sx={{ fontSize: '1.3rem' }}>{metrics.inbound}</Typography>
// <Typography variant="caption">Inbound</Typography>
// </Card>
// <Card sx={{ p: 1.5, textAlign: 'center', background: 'linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)', color: 'white' }}>
// <Typography variant="h6" sx={{ fontSize: '1.3rem' }}>{metrics.qcPassed}</Typography>
// <Typography variant="caption">QC Done</Typography>
// </Card>
// <Card sx={{ p: 1.5, textAlign: 'center', background: 'linear-gradient(135deg, #fa709a 0%, #fee140 100%)', color: 'white' }}>
// <Typography variant="h6" sx={{ fontSize: '1.3rem' }}>{metrics.pickingCompleted}</Typography>
// <Typography variant="caption">Picking Done</Typography>
// </Card>
// <Card sx={{ p: 1.5, textAlign: 'center', background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)', color: 'white' }}>
// <Typography variant="h6" sx={{ fontSize: '1.3rem' }}>{metrics.outboundDispatched}</Typography>
// <Typography variant="caption">Dispatched</Typography>
// </Card>
// </Box>

//         {/* FILTERS - COMPACT */}
//         <Paper elevation={1} sx={{ p: 1, mb: 1, borderRadius: 1 }}>
...
//               sx={{ minWidth: 130, fontSize: '0.5rem' }}
//             />

//             <FormControl size="small" sx={{ minWidth: 130 }}>
//               <InputLabel sx={{ fontSize: '0.85rem' }}>Stage</InputLabel>
//               <Select
//                 value={stageFilter}
...
//                   size="small"
//                   sx={{ borderRadius: 1, background: 'linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)', fontSize: '0.85rem' }}
//                 >
//                   Export
//                 </Button>
//               </Tooltip>
...
//                   loadInventoryData();    
//                   loadMetrics();    
//                   toast.success('✓ Data refreshed'); }} size="small">  <RefreshIcon />
//                 </IconButton>
//               </Tooltip>
//             </Stack>
//           </Stack>
...
//                     </TableCell>
//                   ))}
//                   <TableCell sx={{ fontWeight: 700, fontSize: '0.75rem', bgcolor: '#f5f5f5', textAlign: 'center', width: 40 }}>Action</TableCell>
//                 </TableRow>
//               </TableHead>
//               <TableBody>
//                 {loading ? (
...
//                           return (
//                             <TableCell key={col} sx={{ fontSize: '0.7rem' }}>
//                               <Chip
//                                 label={cellValue}
//                                 size="small"
//                                 sx={{
//                                   backgroundColor: getStatusColor(cellValue),
//                                   color: 'white',
//                                   fontSize: '0.65rem',
//                                   height: 20
//                                 }}
...
//                         return (
//                           <TableCell key={col} sx={{ fontSize: '0.7rem', maxWidth: 200, overflow: 'hidden', textOverflow: 'ellipsis' }}>
//                             {cellValue}
//                           </TableCell>
//                         );
//                       })}
...
//           {/* PAGINATION - COMPACT */}
//           <Box sx={{ p: 1.5, borderTop: '1px solid #e5e7eb', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 1 }}>
//             <Stack direction="row" spacing={1} alignItems="center">
//               <Typography variant="body2" sx={{ fontSize: '0.8rem' }}>Per page:</Typography>
...
//           <DialogTitle sx={{ fontSize: '1rem' }}>Item - {selectedItem?.wsn}</DialogTitle>
//           <DialogContent sx={{ fontSize: '0.9rem' }}>
//             <Stack spacing={1.5} sx={{ mt: 1 }}>
//               <Box>
//                 <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.75rem' }}>Product</Typography>
//                 <Typography variant="body2" sx={{ fontSize: '0.85rem' }}>{selectedItem?.product_title}</Typography>
//               </Box>
//               <Box>
//                 <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.75rem' }}>Brand / Category</Typography>
//                 <Typography variant="body2" sx={{ fontSize: '0.85rem' }}>{selectedItem?.brand} / {selectedItem?.cms_vertical}</Typography>
//               </Box>
//               <Box>
//                 <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.75rem' }}>Price</Typography>
//                 <Typography variant="body2" sx={{ fontSize: '0.85rem' }}>FSP: ₹{selectedItem?.fsp} | MRP: ₹{selectedItem?.mrp}</Typography>
//               </Box>
//               <Box>
//                 <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.75rem' }}>Pipeline</Typography>
//                 <Typography variant="body2" sx={{ fontSize: '0.85rem' }}>Inbound: {selectedItem?.inbound_status} | QC: {selectedItem?.qc_status} | Picking: {selectedItem?.picking_status} | Outbound: {selectedItem?.outbound_status}</Typography>
//               </Box>
//               <Box>
//                 <Typography variant="caption" sx={{ fontWeight: 700, fontSize: '0.75rem' }}>Current Stage</Typography>
//                 <Chip label={selectedItem?.current_stage} size="small" color={getStageColor(selectedItem?.current_stage)} variant="outlined" />
//               </Box>
//             </Stack>
//           </DialogContent>
//           <DialogActions>
...
//                     style={{ marginRight: 8 }}
//                   />
//                   <label style={{ fontSize: '0.85rem' }}>{col.replace(/_/g, ' ').toUpperCase()}</label>
//                 </Box>
//               ))}
//             </Stack>
//           </DialogContent>
