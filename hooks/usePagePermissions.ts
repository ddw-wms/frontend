...
export const useFSNMasterDataPermissions = () =>
  usePagePermissions("fsn_scanning_master");
export const useFSNEntryPermissions = () =>
  usePagePermissions("fsn_scanning_entry");
export const useFSNScannedListPermissions = () =>
