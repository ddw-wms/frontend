...
import {
  ...
  UploadJob,
  UploadStatus,
} from "@/app/context/BulkUploadContext";
...
export default function BulkUploadCard({
  ...
  const bulkDateInputRef = useRef<HTMLInputElement | null>(null);
        ...
        <Stack spacing={{ xs: 1.5, sm: 2 }}>
                ...
                if (field.type === "date") {
                  return (
                    <TextField
                      ...
                      inputRef={bulkDateInputRef}
                      onClick={() => {
                        try {
                          bulkDateInputRef.current?.showPicker?.();
                        } catch {
                ...
                if (field.type === "autocomplete") {
                  return (
                    <Autocomplete
                      ...
                      value={
                        field.options?.find(
                          (o) => o.value === dropdownValues[field.key],
                        ) || null
                      }
                      onChange={(_, newVal) =>
                        setDropdownValues((prev) => ({
                          ...prev,
                          [field.key]: newVal?.value || "",
                        }))
                      }
                      renderInput={(params) => (
                        <TextField
          ...
          >
            ...
            {isValidating ? (
              ...
              <>
                <UploadIcon
                  sx={{ fontSize: { xs: 36, sm: 48 }, color: "#1e40af", mb: 1 }}
                />
                <Typography
                  sx={{
                    fontWeight: 700,
